...
if __name__=='__main__':
    ...
    anomalous_data = readFromFile(artifact_path + "day_6_6_anomalous_path.data")
    database_data = readFromcsv(artifact_path + "day_2_4_path.csv")
    embeddings = np.load(artifact_path + 'day_2_4_path.npy')
    result = {}
    epoch = 1
    ...
    writeToFile(result, artifact_path + "day_6_result.data")
