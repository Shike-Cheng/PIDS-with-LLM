...
if __name__=='__main__':
    knowledge_string_database = readFromFile(artifact_path + "day_2_4_setOfsets.data")
    node2result = readFromFile(artifact_path + "day_6_result.data")
    node2paths = readFromFile(artifact_path + "day_6_6_anomalous_path.data")
    paths2index = readFromFile(artifact_path + "day_6_6_anomalous_path2index.data")
    paths2score = readFromFile(artifact_path + "day_6_6_anomalous_path2score.data")
    nodemap = read(artifact_path + database + '_map' + '.json')
    edges = set()
    start_time = time.time()
    with open(artifact_path + 'day_6_6.csv', newline='') as csvfile:
    ...
    writeToFile(all_malicious_nodes_uuid2msg, artifact_path + "day_6_malicious_nodes_uuid2msg.data")
    writeToFile(all_malicious_nodes_id2msg, artifact_path + "day_6_malicious_nodes_id2msg.data")
