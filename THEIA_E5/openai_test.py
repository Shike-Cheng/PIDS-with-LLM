...
if __name__=='__main__':
    ...
    anomalous_data = readFromFile(artifact_path + "day_15_15_anomalous_path.data")
    database_data = readFromcsv(artifact_path + "day_8_9_path.csv")
    embeddings = np.load(artifact_path + 'day_8_9_path.npy')
    result = {}
    epoch = 1
    ...
    writeToFile(result, artifact_path + "day_15_result.data")
