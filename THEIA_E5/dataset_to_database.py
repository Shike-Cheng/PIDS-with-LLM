...
labels = []
mal_nodes = []
with open(artifact_path + "day_8_9_path.csv", newline='') as csvfile:
...
model.save(artifact_path + "day_8_9_path.model")
model = Doc2Vec.load(artifact_path + "day_8_9_path.model")
...
np.save(artifact_path + 'day_8_9_path.npy', np.array(embeddings))
