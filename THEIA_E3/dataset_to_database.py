...
labels = []
mal_nodes = []
with open(artifact_path + "day_3_5_path.csv", newline='') as csvfile:
...
model.save(artifact_path + "day_3_5_path.model")
...
np.save(artifact_path + 'day_3_5_path.npy', np.array(embeddings))
