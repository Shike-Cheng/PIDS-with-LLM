...
if __name__=='__main__':
    ...
    anomalous_data = readFromFile(artifact_path + "day_17_17_anomalous_path.data")
    database_data = readFromcsv(artifact_path + "day_8_11_path.csv")
    embeddings = np.load(artifact_path + 'day_8_11_path.npy')
    result = {}
    epoch = 1
    ...
    writeToFile(result, artifact_path + "day_17_result.data")
