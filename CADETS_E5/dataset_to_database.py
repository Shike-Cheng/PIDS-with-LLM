...
labels = []
mal_nodes = []
with open(artifact_path + "day_8_11_path.csv", newline='') as csvfile:
...
model.save(artifact_path + "day_8_11_path.model")
model = Doc2Vec.load(artifact_path + "day_8_11_path.model")
...
np.save(artifact_path + 'day_8_11_path.npy', np.array(embeddings))
